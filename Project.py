...
images, labels = load_images_from_path('/content/Spectrograms/class2', 0)
show_images(images)
    
x += images
y += labels

images, labels = load_images_from_path('/content/Spectrograms/class3', 0)
show_images(images)
    
x += images
y += labels

images, labels = load_images_from_path('/content/Spectrograms/class4', 0)
show_images(images)
...
dir_path = '/content/Spectrograms'

# Create a zip file of the directory
zip_file_path = '/content/Spectrograms.zip'
